...
def index():
    ...
    try:
        ...
        return render_template('portfolio_select.html', portfolios=portfolios)
...
def property_select(portfolio_id):
    ...
    try:
        ...
        return render_template('property_select.html', 
...
def property_edit(portfolio_id, property_id):
    ...
    try:
        ...
        return render_template('property_edit.html', 
                             portfolio_id=portfolio_id,
