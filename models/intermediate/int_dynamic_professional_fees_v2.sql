...
-- Dynamic professional fee calculation - auto-adapts to new fee components
-- INLINE LOGIC VERSION - No macros needed!
...
fee_calculations AS (
    SELECT
        ...
        -- DYNAMIC BASE FEES (using CASE statements for each component)
...
SELECT
    ...
    -- METADATA
    'DYNAMIC_CONFIG_V2' AS fee_category,
    'Semi-dynamic model with explicit fee components' AS fee_basis_notes,
