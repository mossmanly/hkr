...
portfolio_terms AS (
  ...
  LEFT JOIN hkh_dev.stg_hurdle_tiers h1
    ON h1.hurdle_id = 'hurdle1'
  LEFT JOIN hkh_dev.stg_hurdle_tiers h2
    ON h2.hurdle_id = 'hurdle2'
  LEFT JOIN hkh_dev.stg_hurdle_tiers h3
    ON h3.hurdle_id = 'hurdle3'
  LEFT JOIN hkh_dev.stg_hurdle_tiers hr
